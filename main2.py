...
from resnext_main import train_resnext, evaluate_resnext, predict_resnext
...
if __name__ == '__main__':
    ...
    model, model_history = train_resnext(sets)
    evaluate_resnext(model, sets)
    pred_masks = predict_resnext(model, sets[2][0])
